...
def run_S4_func_motion_correction_reportlets_only(
    ...
    for run in runs:
        ...
        prefix = run_id
        if session:
            figures_dir = out_path / "derivatives" / "spineprep" / subject / session / "figures"
            func_dir = out_path / "derivatives" / "spineprep" / subject / session / "func"
        else:
            figures_dir = out_path / "derivatives" / "spineprep" / subject / "figures"
            func_dir = out_path / "derivatives" / "spineprep" / subject / "func"
