"""Self-contained tutorial page for the SpinePrep QC dashboard.
...
<title>SpinePrep — Tutorial</title>
<style>{css}</style>
</head>
<body>
<div class="wrap">
<div class="topbar">
<h1>SpinePrep — Tutorial</h1>
...
<p>A SpinePrep-specific QC guard. <code>sct_deepseg</code> can
