...
Outputs per run, under the workfolder:
  ...
  derivatives/spinalfmriprep/<ds>/sub-XX/figures/  (3 QC reportlets)
...
from spinalfmriprep.steps.s3.io import _collect_func_candidates
...
def _process_run(bold_path: Path, run_id: str, subject: str, session: Optional[str],
    ...
    fig_dir = out_path / "derivatives" / "spinalfmriprep" / dataset_key / sub_dir / "figures"
    try:
