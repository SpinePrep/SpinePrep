...
{"".join(rows)}
{cit_section}
<p><small>Generated by SpinalfMRIprep S10.</small></p>
</body></html>"""
    out_path.write_text(html, encoding="utf-8")
    return out_path
...
""" if denoise_ran else "")
    ...
    md = f"""# Methods boilerplate (auto-generated by SpinalfMRIprep S10)
...
def _build_release_report(
    ...
    """Single-page index linking all S10 deliverables."""
    out_path.parent.mkdir(parents=True, exist_ok=True)
...
<p class='muted'>Generated by SpinalfMRIprep S10.</p>
</body></html>"""
