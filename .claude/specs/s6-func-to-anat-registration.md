...
This is the cord-fMRI field-standard recipe (CoSpi `spi06_1fov_reg.sh`,
also adopted by Kaptan 2023 spinal cord toolbox conventions).
...
| Choice | Source |
|---|---|
| 3-stage centermassrot → columnwise → bsplinesyn | CoSpi `spi06_1fov_reg.sh`; field-standard cord recipe |
