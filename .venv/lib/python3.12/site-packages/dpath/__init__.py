...
from dpath.types import Creator, Filter, Glob, Hints, MergeType, Path, PathSegment
...
def delete(
    obj: MutableMapping, glob: Glob, separator="/", afilter: Filter | None = None
) -> int:
    """
...
def set(
    obj: MutableMapping, glob: Glob, value, separator="/", afilter: Filter | None = None
) -> int:
    """
...
def get(
    obj: MutableMapping, glob: Glob, separator="/", default: Any = _DEFAULT_SENTINEL
