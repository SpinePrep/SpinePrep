...
from snakemake.common import ON_WINDOWS, copy_permission_safe, is_local_file, parse_uri
...
from snakemake.io import IOFile, _IOFile, apply_wildcards, contains_wildcard
