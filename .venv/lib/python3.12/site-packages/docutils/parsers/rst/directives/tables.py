...
class RSTTable(Table):
    ...
    def run(self):
        ...
        if isinstance(self.widths, list):
            ...
            colspecs = [
                child for child in tgroup.children if child.tagname == "colspec"
            ]
...
class CSVTable(Table):
    ...
    class HeaderDialect(csv.Dialect):
        ...
        def __init__(self) -> None:
            warnings.warn(
                "CSVTable.HeaderDialect will be removed " "in Docutils 1.0",
                DeprecationWarning,
                stacklevel=2,
            )
            super().__init__()
    ...
    def get_csv_data(self):
        ...
        if self.content:
            ...
            try:
                csv_file = FileInput(
                    source_path=source, encoding=encoding, error_handler=error_handler
                )
        ...
        for row in csv_reader:
            ...
            for cell in row:
                cell_data = (
                    ...
                    0,
                    0,
                    statemachine.StringList(cell.splitlines(), source=source),
                )
