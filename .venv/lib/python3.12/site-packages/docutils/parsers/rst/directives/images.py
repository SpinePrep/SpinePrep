...
class Image(Directive):
    ...
    def run(self):
        ...
        (image_node.source, image_node.line) = self.state_machine.get_source_and_line(
            self.lineno
        )
...
class Figure(Image):
    ...
    def run(self):
        ...
        (figure_node.source, figure_node.line) = self.state_machine.get_source_and_line(
            self.lineno
        )
        if figwidth == "image":
