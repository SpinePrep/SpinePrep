...
def test_qc_no_external_cdn():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert "http://" not in content or "localhost" in content  # Allow localhost for dev
        assert "https://" not in content or "https://github.com" in content  # Only repo link allowed
